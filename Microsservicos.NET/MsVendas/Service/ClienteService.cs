namespace Service
{
    ...
    public class ClienteService : MicroService<ClienteService>, IClienteService
    {
        public ClienteService(IDiscoveryClient client, ILoggerFactory logFactory): base(client, logFactory) { }
